...
import me.asyc.jchat.server.network.packet.impl.out.ServerHandshakePacket;
...
public final class SocketChannelInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel channel) {
		...
		channel.writeAndFlush(new ServerHandshakePacket(JChatServer.INSTANCE.getCryptoManager().getHandshakeKeyPair().getPublic().getEncoded(), validate));
	}
